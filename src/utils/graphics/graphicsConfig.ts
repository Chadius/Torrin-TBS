...
export const GraphicsConfig = {
    ...
    isCoordinateWithinMiddleThirdOfScreen: (xCoordinate: number, yCoordinate: number): boolean => {
...
const isCoordinateWithinMiddleThirdOfScreen: (xCoordinate: number, yCoordinate: number) => boolean = (xCoordinate: number, yCoordinate: number) => {
    return (
