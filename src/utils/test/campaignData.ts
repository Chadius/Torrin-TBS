    ...
    const testCampaignFile: CampaignFileFormat = {
        ...
        resources: {
            missionMapMovementIconResourceKeys: {
                MOVE_1_ACTION_CONTROLLABLE_SQUADDIE: "map icon move 1 action",
                MOVE_2_ACTIONS_CONTROLLABLE_SQUADDIE: "map icon move 2 actions",
                MOVE_3_ACTIONS_CONTROLLABLE_SQUADDIE: "map icon move 3 actions",
