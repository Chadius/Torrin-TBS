import {MissionFileFormat, MissionFileFormatService, NpcTeamMissionDeploymentService} from "./missionLoader";
...
describe('missionLoader', () => {
    describe('sanitization', () => {
        ...
        it('makes empty enemy section if it is missing', () => {
            MissionFileFormatService.sanitize(validMission);
            expect(validMission.npcDeployments.enemy).toEqual(NpcTeamMissionDeploymentService.new({}));
            expect(validMission.npcDeployments.ally).toEqual(NpcTeamMissionDeploymentService.new({}));
            expect(validMission.npcDeployments.noAffiliation).toEqual(NpcTeamMissionDeploymentService.new({}));
        });
