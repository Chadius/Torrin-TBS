...
export const SplashScreenPlayerService = {
    ...
    draw: (splashScreenPlayerState: SplashScreenPlayerState, graphicsContext: GraphicsRenderer): void => {
...
const drawBackground = (state: SplashScreenPlayerState, graphicsContext: GraphicsRenderer) => {
