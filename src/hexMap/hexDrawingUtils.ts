...
export function drawHexShape(graphicsContext: GraphicsRenderer, worldX: number, worldY: number, cameraX: number, cameraY: number) {
...
export const HexDrawingUtils = {
    drawHexMap: (graphicsContext: GraphicsRenderer, map: TerrainTileMap, camera: BattleCamera) => {
