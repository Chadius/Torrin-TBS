...
export class MakeDecisionButton {
    ...
    drawActionPoints(graphicsContext: GraphicsRenderer, top: number) {
    ...
    drawActionRange = (graphicsContext: GraphicsRenderer, top: number) => {
    ...
    drawActionTemplateEffect = (graphicsContext: GraphicsRenderer, top: number) => {
    ...
    drawInfoTextBox = (graphicsContext: GraphicsRenderer, top: number, text: string) => {
        const buttonTextBox: TextBox = TextBoxService.new({
            area: RectAreaService.new({
                left: RectAreaService.left(this.buttonIcon.area),
                top: top,
