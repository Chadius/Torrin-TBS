...
describe('team strategy calculator', () => {
    describe('getCurrentlyActingSquaddieWhoCanAct', () => {
        ...
        beforeEach(() => {
            ...
            ObjectRepositoryService.addBattleSquaddie(repository, battleSquaddie0);
            ObjectRepositoryService.addBattleSquaddie(repository, battleSquaddie1);
        ...
        it('returns the squaddie who started their turn', () => {
            const actionThisRound = ActionsThisRoundService.new({
                ...
                previewedActionTemplateId: "actionTemplate",
            });
            expect(TeamStrategyService.getCurrentlyActingSquaddieWhoCanAct(team, actionThisRound, repository)).not.toBeUndefined();
        });
    });
});
