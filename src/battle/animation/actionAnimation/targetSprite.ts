...
export class TargetSprite {
    ...
    draw(timer: ActionTimer, graphicsContext: GraphicsRenderer, actionEffectSquaddieTemplate: ActionEffectSquaddieTemplate, result: ActionResultPerSquaddie) {
    ...
    getSquaddieImageBasedOnTimer(timer: ActionTimer, graphicsContext: GraphicsRenderer, actionEffectSquaddieTemplate: ActionEffectSquaddieTemplate) {
    ...
    private drawActorSprite(timer: ActionTimer, graphicsContext: GraphicsRenderer, actionEffectSquaddieTemplateService: ActionEffectSquaddieTemplate, result: ActionResultPerSquaddie) {
