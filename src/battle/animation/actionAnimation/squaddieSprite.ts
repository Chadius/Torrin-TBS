...
export class SquaddieSprite {
    ...
    public getSpriteBasedOnEmotion(emotion: SquaddieEmotion, graphicsContext: GraphicsRenderer): ImageUI {
    ...
    private defaultEmptyImage(graphicsContext: GraphicsRenderer): ImageUI {
        if (defaultImage) {
            return defaultImage;
        }
