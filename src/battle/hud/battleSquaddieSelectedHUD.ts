...
export class BattleSquaddieSelectedHUD {
    ...
    draw(state: GameEngineState, graphicsContext: GraphicsRenderer) {
    ...
    private drawSquaddieID(state: BattleOrchestratorState, graphicsContext: GraphicsRenderer) {
    ...
    private drawActionPoints(state: GameEngineState, graphicsContext: GraphicsRenderer) {
        const {
            squaddieTemplate,
            battleSquaddie
        } = getResultOrThrowError(ObjectRepositoryService.getSquaddieByBattleId(state.repository, this.selectedBattleSquaddieId));
    ...
    private drawHitPoints(state: GameEngineState, graphicsContext: GraphicsRenderer) {
        const {
            squaddieTemplate,
            battleSquaddie
        } = getResultOrThrowError(ObjectRepositoryService.getSquaddieByBattleId(state.repository, this.selectedBattleSquaddieId));
    ...
    private drawSquaddieActions(graphicsContext: GraphicsRenderer) {
        this.makeDecisionButtons.forEach((button) => {
    ...
    private drawSquaddieAttributes(state: GameEngineState, graphicsContext: GraphicsRenderer) {
        const {
            squaddieTemplate,
            battleSquaddie
        } = getResultOrThrowError(ObjectRepositoryService.getSquaddieByBattleId(state.repository, this.selectedBattleSquaddieId));
    ...
    private maybeDrawEndTurnButton(state: GameEngineState, graphicsContext: GraphicsRenderer) {
