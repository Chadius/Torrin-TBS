...
export class BattleMapDisplay implements BattleOrchestratorComponent {
    draw(gameEngineState: GameEngineState, graphicsContext: GraphicsRenderer): void {
    ...
    private drawSquaddieMapIcons(state: GameEngineState, graphicsContext: GraphicsRenderer, battleSquaddieIdsToOmit: string[]) {
