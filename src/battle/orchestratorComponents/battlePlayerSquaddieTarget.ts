...
export class BattlePlayerSquaddieTarget implements BattleOrchestratorComponent {
    ...
    private drawCancelAbilityButton(state: BattleOrchestratorState, graphicsContext: GraphicsRenderer) {
    ...
    private drawConfirmWindow(state: GameEngineState, graphicsContext: GraphicsRenderer) {
        this.drawButton(
            RectAreaService.new({
                left: 0,
                top: BUTTON_TOP,
    ...
    private drawButton(area: RectArea, buttonText: string, graphicsContext: GraphicsRenderer) {
