...
export class BattleOrchestratorState {
    ...
    get missingComponents(): TBattleOrchestratorStateValidityReason[] {
...
export const BattleOrchestratorStateValidityReason = {
    MISSING_NUMBER_GENERATOR: "MISSING_NUMBER_GENERATOR",
    INVALID_BATTLE_STATE: "INVALID_BATTLE_STATE",
} as const satisfies Record<string, string>

export type TBattleOrchestratorStateValidityReason = EnumLike<
    typeof BattleOrchestratorStateValidityReason
>
