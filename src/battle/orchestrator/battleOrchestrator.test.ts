...
describe('Battle Orchestrator', () => {
    ...
    describe('mouse events', () => {
        ...
        const expectMouseEventsWillGoToMapDisplay = (
            ...
            const stateWantsToDisplayTheMap: GameEngineState = GameEngineStateService.new({
                resourceHandler: undefined,
                battleOrchestratorState: BattleOrchestratorStateService.newOrchestratorState({
                    battleState: BattleStateService.newBattleState({
                        missionId: "test mission",
            ...
            squaddieSelectorOrchestratorShouldDisplayMap.mouseClicked(stateWantsToDisplayTheMap, MouseButton.ACCEPT, 0, 0);
